                        ...
                        {canWrite && (
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem
                                onClick={() => archiveMut.mutate({ id: project.id })}
                      ...
                      <div className="flex items-center gap-1">
                        {project.members.slice(0, 5).map((m) => (
                          <div
                            ...
                            className="bg-muted border-background flex h-6 w-6 items-center justify-center rounded-full border text-[10px] font-medium"
                          >
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={createMut.isPending || !form.name || !form.code}
            >
